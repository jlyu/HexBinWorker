...
unsigned char IntelHex::stringToHex(string value)
{
    ...
    if(value.length() == 2)
    {
        ...
        for (int x=0; x < 2; x++)
        {
            ...
            else
            {
                ...
                //message = _T("Can't convert byte 0x") + value + _T(" @ 0x") + ulToHexString(segmentBaseAddress) + _T(" to hex.");
    ...
    else
    {
        ...
        //message = value + " @ 0x" + ulToHexString(segmentBaseAddress) +  " isn't an 8-bit value.";
